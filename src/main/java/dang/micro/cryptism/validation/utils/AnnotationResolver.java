...
import dang.micro.cryptism.validation.annotations.Ignore;
import dang.micro.cryptism.validation.annotations.ValidatedBy;
import dang.micro.cryptism.validation.utils.exceptions.ProviderResolveException;
import dang.micro.cryptism.validation.utils.exceptions.ValidationException;
import dang.micro.cryptism.validation.utils.exceptions.ValidatorDeclarationException;
import dang.micro.cryptism.validation.utils.exceptions.ValidatorNotFoundException;
...
import dang.micro.cryptism.validation.validator.impl.ChainRegistry;
import dang.micro.cryptism.validation.validator.impl.CollectionInternalValidatorChain;
import dang.micro.cryptism.validation.validator.impl.PojoValidatorChain;
import dang.micro.cryptism.validation.validator.impl.ValidatorChain;
...
public class AnnotationResolver {
    /**
     * Read an object class which has fields wrapped with @Constraints & resolve it into {@link ChainPrototype}
     * @param objectClass: Class of an object we want to resolve
     * @return {@link ChainPrototype}
     */
